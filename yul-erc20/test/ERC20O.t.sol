...
import {TestERC20O} from "../src/test/TestERC20O.sol";
import {ERC20O, IERC20, IERC20Errors} from "../src/ERC20O.sol";

contract ERC20OTest is Test {
    TestERC20O token;
    ...
    function setUp() public {
        ...
        vm.prank(holder);
        token = new TestERC20O("MyToken", "MTK");
    }
    ...
    function test_Constructor() public {
        ...
        vm.prank(holder);
        TestERC20O newToken = new TestERC20O(name, symbol);
